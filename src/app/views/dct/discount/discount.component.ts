      ...
      this.rows.forEach(x=>
        {
          ...
          this.rows[counter].expireDate=moment(this.rows[counter].expireDate, 'YYYY/MM/DD').locale('fa').format('YYYY/MM/DD');
          this.rows[counter].createDate=moment(this.rows[counter].createDate, 'YYYY/MM/DD').locale('fa').format('YYYY/MM/DD');
          counter++;
        })
...
this.checkbox=!this.checkbox
  ...
  createDiscount(){
    ...
    this.ShowModel.expireDate= moment.from(this.ShowModel.expireDate, 'fa', 'YYYY-MM-DD').format('YYYY-MM-DD');  
