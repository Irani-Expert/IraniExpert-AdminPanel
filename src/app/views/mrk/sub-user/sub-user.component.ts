  ...
  arrayData: UserDataModel[] = [
    {
      ...
      parentUserID: null,
      childsCount: null,
      phoneNumber: this._auth.currentUserValue['phoneNumber'],
      accountNumber: this._auth.currentUserValue['accountNumber'],
    },
  ];
  arrayData2: UserDataModel[] = [
    {
      userID: 3243,
      email: '000',
      firstName: this._auth.currentUserValue.firstName,
